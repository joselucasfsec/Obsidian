...
Vamos alterar o tamanho do campo de username e vamos fazer um LFI. Devemos enviar o payload para aplicação no campo de cookies codificado em base64:
```
...
Analisando o código fonte temos que o parâmetro auth também é vulneral a LFI pois ele não é validado:
